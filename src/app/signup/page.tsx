  ...
  const handleGoogleSignUp = async () => {
    ...
    if (!auth) {
        toast({
            ...
            description: "Конфігурація Firebase не знайдена. Переконайтеся, що змінні середовища налаштовані у вашому хостинг-середовищі.",
        });
        setLoading(false);
        return;
    }
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Помилка реєстрації',
        description: 'Можливо, користувач з такою поштою вже існує.',
      });
      setLoading(false);
    }
  };
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Створіть новий акаунт, щоб почати</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
